...
BYTE ADC_CHANNELS = 0,CH123SA=0,CHOSA=3,SINE_AMP = 2; // CH1 only
BYTE TRIGGER_CHANNEL=0,TRIGGERED=0,TRIGGER_READY=0,SH,I2C_TRIGGER_CHANNEL=0,I2C_TRIGGERED=0,I2C_TRIGGER_READY=0, I2C_SCOPE_LOCATION=0x00,I2C_SCOPE_ADDRESS=0x00,I2C_SCOPE_BYTES=0;
