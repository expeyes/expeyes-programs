...
class Eyesjun:
	...
	def __init__(self, dev = None):
		...
		for dev in device_list:
			...
			#For Ubuntu 13.10 and above, sometimes opening fails. Strange, but closing and re-opening with
			#another baudrate solves the prblesm. The following 4 lines added for that
			handle.close()
...
#-----------------------------------EEPROM----------------------------------
	...
	def storeCF_ref(self, ref):			# reference voltage
		'''
		Stores the calibration factor of REF to EEPROM. Returns None or 1
		'''
