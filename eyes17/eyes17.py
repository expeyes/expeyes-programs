...
if platform.platform() == 'Windows':
	import diode_iv, pendulumVelocity, RLtransient, soundVelocity, pnpCEout, rodPendulum, sr04dist
	import filterCircuit, RCsteadystate, scope, induction, RCtransient, RLCsteadystate, soundBeats
	import npnCEout, RLCtransient, soundFreqResp
...
class MainWindow(QMainWindow):
	...
	def scope_help(self,e):
		if self.expName != 'scope':
			self.callExpt(electronicsExptsScope[0])
		else:
			self.hwin = None
			self.hlpName = e[1]
			self.title = e[0]
