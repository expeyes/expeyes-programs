...
def update():
	...
	try:
		g.delete_lines()
		if ShowVcl.get() == 1:
			data[0][0], data[0][1], data[1][0], data[1][1], t, a3, t, a4 = p.capture4(NP,delay)
			g.line(t, data[0][1]-a3, 3)   # Vcap
			g.line(t, a3-data[1][1],4)    # Vind
		else:
...
ShowVcl = IntVar()
b = Checkbutton(rf, text=_('Show Vcap & Vind (with A3)'), variable = ShowVcl, fg = 'black')
...
#set_frequency(0)
t = _('Steady state response of RLC circuits')
eyeplot.pop_help('RLCsteadystate', t)
root.title(t)
