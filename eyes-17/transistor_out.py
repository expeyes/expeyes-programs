...
def start():
	...
	vb = p.get_voltage('A2')    # base voltage
	if vb < 0.5 or vb > 0.7:
		vb = 0.6
...
t= _('NPN Transistor CE mode output characteristic')
eyeplot.pop_help('transistor_out', t)
root.title(t)
root.mainloop()
